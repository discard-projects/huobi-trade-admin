<template>
  <div @click="toggleActive" style="display: inline-block; height: 30px">
    <svg t="1492500959545" class="hamburger" :class="{'is-active':currentValue}" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1691" xmlns:xlink="http://www.w3.org/1999/xlink" width="64" height="64">
...
export default {
  ...
  computed: {
    currentValue: {
      ...
      set (nv) {
        this.$store.dispatch('app.toggleSideBar', nv)
      }
    }
  },
  methods: {
